...
public class Constants {
	...
	public static String radio = "Radiology";
	public static String cardio = "Cardiology";
	public static String mat = "Maternity";
	public static String er = "Emergency Room";
	public static String burn = "Burn Unit";
